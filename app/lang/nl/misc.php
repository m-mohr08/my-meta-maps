...
return array(
	...
	*/
	...
	'howtoSeeComments' => 'Hoe kan ik de commentaren van geo-gegevens zien?',
	'howtoShare' => 'Deel My Meta Maps met verdere mensen',
	'howtoLoginViaOAuth' => 'Meld je over een extern anbieder aan',
	'howtoChangeGeneral' => 'Hoe kan ik mijn profiel wijzigen?',
	'howtoChangePassword' => 'Hoe kan ik mijn wachtwoord wijzigen?',
	'filterInfoTitle' => 'Informatie over de filters',
	'filterInfo' => 'De filters beroepen zich op de commentaren van geo-gegevens. Maar als je bij de trefwoordzoek de meta-gegevens wil integreren, kan je dat met de checkbox doen.',
	...
	'loginViaOAuth' => 'Je kan je ook via Facebook, GitHub, Google of Twitter aanmelden. Daarna cree&umlren we een My Meta Maps account for jij.',
	'changeGeneral' => 'Boven vindt je ook een knopje met je profielnaam. Je kan er je profiel-gegevens wijzigen. Je kan je profielnaam en je mail-adress wijzigen en je prefereerde taal kiezen.',
	'changePassword' => 'Boven vindt je een knopje met je profielnaam, je kan er je wachtwoord wijzigen.',
	'buttonComment' => 'Boven vindt je het knopfe om een commentaar te cree&umlren',
	'noRegNec' => 'Je moet niet registreert of aangemeld zijn om een commentaar toetevoegen.',
	'addCommentSteps' => 'Het toevoegen van een commentaar doe je in twee stappen:',
	'addCommentStepOne' => 'Geef de URL van de geo-gegevens in en kies het passend gegevens-format. Als het niet lukt, krijg je de redenen.',
	'addCommentStepTwo' => 'Hier kan je de titel voor de geo-gegevens vastleggen. En als er nog geen commentaren bestaan, kan je ook een layer kiezen en een vrijtekst ingeven, een geometrie ingeven, een tijdsbestek vastleggen en een beoordeling geven.',
	'addCommentNote' => 'Let op: De vrijtekst is verplichtend. Bij het toevoegen van een geometrie kan je tussen een punt, een lijn of een polygoon kiezen. Maar je kan alleen een van deze drie geometrien toevoegen.',
	'addCommentTipp' => 'Tip: In het overzicht van de commentaren van een geo-gegeven kan je ook rechtstreeks voor deze geo-gegeven een commentaar cree&umlren en zo de eerste stap overslaan.',
	...
	'seeComments' => 'Beneden kan je een lijst van geo-gegevens zien, waartoe, passend toe de filters, commentaren bestaan. Door een click bereik je het overzicht met de commentaren.
	 Als de filters commentaren selecteren, kan je nu zien hoeveel commentaren er voor de geo-gegeven bestaan. Zonder filters krijg je alle commentaren te zien.',
	'commentsFurtherInfos' => 'Je zie allereerst een lijst met allgemeen commentaren en ook voor de respektievelijk layer. Door een click op het respectievelijk element kan je de respectievelijk commentaren zien. 
	Hier zie je ook wie de commentar heeft toegevoegd en ook de beeordeling en de tijdsbestek van het commentaar. Rechterkant kan je bovendien allgemeene- en meta-gegevens zien en op een kaart zie je de bounding-box van de geo-gegevens.',
	'shareMMM' => 'Je kan het symbool in de lijst met de geo-gegevens en ook in het overzicht met de commentaren van een geo-gegeven zien',
	'shareMMMFurtherInfos' => 'Je kan ermee je gefilterd lijst van geo-gegevens, de lijst van commentaren voor een previes geo-gegeven maar ook alleen een enkele commentaar delen.', 
