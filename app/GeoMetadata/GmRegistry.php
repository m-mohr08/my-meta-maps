...
class GmRegistry {
	...
	// EPSG codes / Inverted axis order
	
	/**
	 * Takes a namespace and tries to parse the EPSG code number from it.
	 * 
	...
	public static function getEpsgCodeNumber($code) {
		...
		foreach($prefixes as $prefix) {
			if (stripos($code, $prefix) === 0) {
				// Prefix found at the beginning of the string, get the rest of the string
	...
	/**
	 * List of EPSG-Codes (only the numbers) that use inversed axis order for coordinates.
	 * 
	 * List is copied from MapServer 6 source, licensed under a MIT-style license.
	 * 
	 * @see https://github.com/mapserver/mapserver/blob/master/mapaxisorder.csv
	 * @see https://github.com/mapserver/mapserver/blob/master/README
	 */
	private static $invertedAxisOrderEpsCode = array(
		4326,
		4258,
		31466,
		31467,
