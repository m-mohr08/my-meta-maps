<h4 class="modal-title" id="meinModalLabel">Kommentar erstellen</h4>
	...
	<form id="form-comment" onsubmit="return false">
		...
		<div class="row form-group form-group-marginSides">
			<label for="startDate">Zeitraum</label>
				<div class="input-group">
					<input class="form-control" readonly name="startDate" id="inputStartDate" type="text"placeholder="Startzeitpunkt">
		...
		<div class="row form-group form-group-marginSides">
			<div class="input-group">
				<input class="form-control" readonly name="endDate" id="inputEndDate" type="text"placeholder="Endzeitpunkt">
