		...
		<form class="modal-content" id="form-changeGeneral" onsubmit="return false">
			...
			<div class="modal-body">
				...
				<div class="row form-group form-group-marginSides">
					...
					<input class="form-control" name="name" id="inputChangeUsername" type="text" value="{{{ Auth::user()->name }}}" onchange="userCheckDataController('inputChangeUsername', 'form-changeGeneral', 'name')">
					<div class="error-message"></div>
				</div>

				<div class="row form-group form-group-marginSides">
					<label for="email">@lang('misc.mail')</label>
					<input class="form-control" name="email" id="inputChangeMail" type="text" value="{{{ Auth::user()->email }}}" onchange="userCheckDataController('inputChangeMail', 'form-changeGeneral', 'email')">
					<div class="error-message"></div>
				</div>
